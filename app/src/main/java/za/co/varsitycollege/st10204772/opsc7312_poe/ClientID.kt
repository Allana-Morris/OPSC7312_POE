...
object ClientID {
    ...
    const val REDIRECT_URI3 = "myapp://callback3"
    const val CLIENT_SECRET = "44bdee846c714d22ad432b9b7cb1451b"
    const val app_client_id =
        "905988466931-7dgl1beg0omvj4k1r0ct11sos1eghgsv.apps.googleusercontent.com"
    const val FCM_KEY =
        "BFwEl2YF1CdTEooww3FY2eh0_g5JQcHF1uus_7TlWzugwDty29HcVmF_ZQyv_6x26jD0KDV7OxSgTxvV1ov_IhM"
